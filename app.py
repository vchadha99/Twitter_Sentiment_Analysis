...
with open(os.path.join('F:\Twitter_Sentiment_Analysis','tokenizer.pickle'), 'rb') as handle:
...
def sent_anly_prediction():
    if request.method=='POST':
        ...
        with graph.as_default():
            ...
            model = load_model(os.path.join(r"F:\Twitter_Sentiment_Analysis\Notebook", 'sentiment_analysis.h5'))
